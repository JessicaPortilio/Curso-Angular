...
@Directive({
  // O selector: 'app-Card-Avatar-Small' faz com que essa diretiva possa ser usada como um elemento HTML.
  selector: 'app-Card-Avatar-Small, [appCardAvatarSmall]', // Define o seletor para ser usado no HTML
  // O host: {'class': 'ca-u-card-avatar-small'} adiciona automaticamente a classe CSS correta (ca-u-card-avatar-small) ao elemento, sem precisar definir manualmente. 
  host: {'class': 'ca-u-card-avatar-small'} // Aplica automaticamente a classe CSS ao elemento
})
